...
class TR:
    ...
    session_timeout__confirm_desc: str = "Do you want to enable session? This mode is useful to make a sequence of transactions without the need to re-enter PIN. It will also change behavior of Trezor, clicking power button, will only lock the screen, to lock device hold power button for 1 second."
    session_timeout__info: str = "Session will ease doing sequence of transactions. Set the time after Trezor will lock itself."
    session_timeout__title: str = "Session"
